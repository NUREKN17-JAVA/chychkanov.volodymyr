...
import ua.nure.kn.chychkanov.usermanagement.db.DaoFactoryImpl;
import ua.nure.kn.chychkanov.usermanagement.db.MockDaoFactory;
import ua.nure.kn.chychkanov.usermanagement.db.MockUserDao;
...
public class MainFrameTest extends JFCTestCase {
	...
	protected void setUp() throws Exception {
		...
		mockUserDao.expectAndReturn("findAlll", new ArrayList());
	...
	public void testAddUser() {
		...
		String name = "addPanel";
		find(JPanel.class, name);	
